...
\bibitem{ref13}
Mehta, H., Jain, S., Mhatre, K., Jain, S., \& Khairnar, M. (2026). \textit{Auto
ITR: An Automated Indian Income Tax Return Preparation System using Hybrid
Rule-Based and Heuristic AI}. International Journal of Engineering Research \&
Technology (IJERT), 15(5), Paper ID IJERTV15IS050756.
\url{https://www.ijert.org/}

\bibitem{ref14}
Mulla, M., Mulani, S., Kamble, K., Takmare, S. B., \& Patil, S. V. (2026).
\textit{AI-Powered Tax Calculation and ITR Suggestion System}. International
Research Journal on Advanced Engineering Hub (IRJAEH), 4(2), 844--848.
\url{https://doi.org/10.47392/IRJAEH.2026.0120}
